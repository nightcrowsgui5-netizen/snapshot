...
(function () {
  ...
  var translations = {
    pt: {
      ...
      "services.s1_title": "Filmes & Vídeos Publicitários",
      ...
      "services.s2_title": "Clipes & Vídeos Musicais",
      "services.s2_desc": "Damos vida à música com clipes criativos e envolventes, do conceito à edição final, capturando a essência de cada artista.",
      "services.s3_title": "Produção de Curtas-Metragens",
      "services.s3_desc": "Contamos histórias que emocionam por meio de curtas-metragens com direção, roteiro e produção cuidadosamente elaborados.",
    ...
    en: {
      ...
      "services.s1_title": "Movies & Advertising Videos",
      ...
      "services.s2_title": "Clip & Music Videos",
      "services.s2_desc": "We bring music to life with creative and engaging videos, from concept to final edit, capturing the essence of every artist.",
      "services.s3_title": "Short Film Productions",
      "services.s3_desc": "We tell moving stories through short films with carefully crafted direction, script and production.",
